...
function InitComponent(GUIController MyController, GUIComponent MyOwner)
{
	...
	moCheckBox(Controls[13]).Checked(LastAutoAdjustSkill);
}

function string Play()
{
	LastAutoAdjustSkill = moCheckBox(Controls[13]).IsChecked();
	SaveConfig();
...
defaultproperties
{
	...
	End Object
	Controls(12)=GUIImage'IARulesBK4'
	...
	End Object
	Controls(13)=moCheckBox'IARulesAutoAdjustSkill'
