...
#exec  TEXTURE IMPORT NAME=RedMarker_t FILE=Textures\RedMarker.TGA Mips=Off LODSET=0
#exec  TEXTURE IMPORT NAME=BlueMarker_t FILE=Textures\BlueMarker.TGA Mips=Off LODSET=0
