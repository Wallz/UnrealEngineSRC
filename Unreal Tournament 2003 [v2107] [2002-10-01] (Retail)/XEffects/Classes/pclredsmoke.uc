...
#exec  TEXTURE IMPORT NAME=TrailLifeMap_t FILE=Textures\RocketTrailColorMap.PCX Mips=Off LODSET=0
#exec  TEXTURE IMPORT NAME=WispSmoke_t FILE=Textures\smoke_wisp.tga LODSET=2
