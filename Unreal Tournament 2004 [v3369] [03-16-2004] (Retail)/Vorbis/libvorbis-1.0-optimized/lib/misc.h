 ...
 ********************************************************************
 ...
 last mod: $Id: misc.h,v 1.1.1.1 2003/10/12 23:51:40 root Exp $
...
#if MACOSX
   extern int __oggHasEnabledVectorUnit;
   void _ogg_set_vector_unit(int isOn);
#  define _vorbis_has_vector_unit() (__oggHasEnabledVectorUnit)
