 ...
 ********************************************************************
 ...
 last mod: $Id: window.c,v 1.1.1.1 2003/10/12 23:51:40 root Exp $
...
int __oggHasEnabledVectorUnit = 0;
void _ogg_set_vector_unit(int isOn) { __oggHasEnabledVectorUnit = isOn; }
