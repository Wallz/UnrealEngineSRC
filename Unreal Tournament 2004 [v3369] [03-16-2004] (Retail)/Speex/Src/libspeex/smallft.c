...
void speex_drft_forward(struct drft_lookup *l,float *data){
  if(l->n==1)return;
  drftf1(l->n,data,l->trigcache,l->trigcache+l->n,l->splitcache);
}

void speex_drft_backward(struct drft_lookup *l,float *data){
  if (l->n==1)return;
  drftb1(l->n,data,l->trigcache,l->trigcache+l->n,l->splitcache);
}

void speex_drft_init(struct drft_lookup *l,int n){
  l->n=n;
...
void speex_drft_clear(struct drft_lookup *l){
  if(l){
